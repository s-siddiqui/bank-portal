...
module.exports = (env, argv) => {
  ...
  return {
    ...
    output: {
      ...
      publicPath: isProd ? "/bank-portal/host/" : "auto",
      clean: true,
    },
    resolve: {
      ...
      alias: {
        ...
        "ui-kit": path.resolve(__dirname, "../ui-kit/dist"),
      },
    },
    optimization: isProd
      ? {
    ...
    plugins: [
      new ModuleFederationPlugin({
        ...
        remotes: {
          mf_account: isProd
            ? "mf_account@/bank-portal/mf-account/remoteEntry.js"
            : "mf_account@http://localhost:3001/remoteEntry.js",
          mf_transactions: isProd
            ? "mf_transactions@/bank-portal/mf-transactions/remoteEntry.js"
            : "mf_transactions@http://localhost:3002/remoteEntry.js",
        },
        shared: {
          react: {
            singleton: true,
